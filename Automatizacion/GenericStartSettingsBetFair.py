...
Casino = "Apuestas de Fútbol - Cuotas de Fútbol hoy | Betfair™ Sportsbook"
Casino2 = "ApuestasAndalucia"
Casino3 ="bwin"
Casino4="Interwetten"
SelectedCasino = 1
...
while df.empty:
    df = te.get_df_uiautomator2(with_screenshot=False)
    df = df.loc[df["aa_content_desc"] == "Menu"]
